---
title: Pak Files
description: 'A custom archive format for storing compressed files'
---
...
:::warning
The following applies to the 3 main games: Kula World, Roll Away, and Kula Quest. Demos may apply differently!
:::
